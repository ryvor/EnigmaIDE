...
function registerKeybinds() {
	if(!globalShortcut.register('Alt+A', ()=>openAbout())) console.log('Failed to register global shortcut 1');
	...
	if(!globalShortcut.register('CommandOrControl+O', ()=>openDialog(1))) console.log('Failed to register global shortcut 7');
	if(!globalShortcut.register('CommandOrControl+Shift+O', ()=>openDialog(2))) console.log('Failed to register global shortcut 8');
	//---//
