(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    define(["../lib/enigma", "../htmlmixed/htmlmixed"], mod);
  ...
  Enigma.defineMode("soy", function(config) {
    var textMode = Enigma.getMode(config, "text/plain");
    var modes = {
      html: Enigma.getMode(config, {name: "text/html", multilineTagIndentFactor: 2, multilineTagIndentPastTag: false, allowMissingTagName: true}),
      attributes: textMode,
      text: textMode,
      uri: textMode,
      trusted_resource_uri: textMode,
      css: Enigma.getMode(config, "text/css"),
      js: Enigma.getMode(config, {name: "text/javascript", statementIndent: 2 * config.indentUnit})
    };
    ...
    return {
      startState: function() {
        return {
          ...
          localStates: [{
            mode: modes.html,
            state: Enigma.startState(modes.html)
          }]
        };
      },
        ...
        return {
          ...
          localStates: state.localStates.map(function(localState) {
            return {
              ...
              state: Enigma.copyState(localState.mode, localState.state)
            };
          })
        };
      },
      ...
      indent: function(state, textAfter, line) {
        ...
        if (top == "comment") return Enigma.Pass;
  ...
  Enigma.registerHelper("wordChars", "soy", /[\w$]/);

  Enigma.registerHelper("hintWords", "soy", Object.keys(tags).concat(
      ["css", "debugger"]));

  Enigma.defineMIME("text/x-soy", "soy");
});
