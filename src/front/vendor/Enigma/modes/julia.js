...
Enigma.defineMode("julia", function(config, parserConf) {
  ...
  Enigma.registerHelper("hintWords", "julia", keywordsList.concat(builtinsList));
...
Enigma.defineMIME("text/x-julia", "julia");
