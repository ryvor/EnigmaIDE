(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    mod(require("../lib/enigma"), require("../../addon/mode/simple"));
  else if (typeof define == "function" && define.amd) // AMD
    define(["../lib/enigma", "../../addon/mode/simple"], mod);
  else // Plain browser env
    mod(Enigma);
})(function(Enigma) {
"use strict";

Enigma.defineSimpleMode("rust",{
  start: [
...
Enigma.defineMIME("text/x-rustsrc", "rust");
Enigma.defineMIME("text/rust", "rust");
});
