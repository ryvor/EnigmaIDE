...
Enigma.defineMode("verilog", function(config, parserConfig) {
  ...
  */
  ...
  return {
    ...
    indent: function(state, textAfter) {
      if (state.tokenize != tokenBase && state.tokenize != null) return Enigma.Pass;
      if (hooks.indent) {
  ...
  Enigma.defineMIME("text/x-verilog", {
    name: "verilog"
  });

  Enigma.defineMIME("text/x-systemverilog", {
    name: "verilog"
  });
